...
public class Base_Class {
	...
	/*
	 * public static String excelCodeAdactinHotel(int row, int cell) throws
	 * Exception {
	 * 
	 * File f = new File(
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
	 * ); FileInputStream fis = new FileInputStream(f); XSSFWorkbook w = new
	 * XSSFWorkbook(fis); XSSFSheet sheet = w.getSheetAt(0); XSSFRow rows =
	 * sheet.getRow(row); XSSFCell cells = rows.getCell(cell); int cellType =
	 * cells.getCellType();
	 * 
	 * String value = " ";
	 * 
	 * if (cellType == 1) {
	 * 
	 * value = cells.getStringCellValue(); } else if
	 * (DateUtil.isCellDateFormatted(cells)) {
	 * 
	 ...
	 * else {
	 * 
	 * double dd = cells.getNumericCellValue(); long l = (long) dd; value =
	 * String.valueOf(l);
	 * 
	 * }
	 * 
	 ...
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
	 * ); FileInputStream fis = new FileInputStream(f); XSSFWorkbook w = new
	 * XSSFWorkbook(fis); XSSFSheet sheet = w.getSheet("Sheet1"); XSSFRow rows =
	 * sheet.getRow(row); XSSFCell cells = rows.getCell(cell); int cellType =
	 * cells.getCellType();
	 * 
	 * String value = " ";
	 ...
	 * return value; }
	 * 
	 * public static void excelWrite(int row, int cell, String value) throws
	 * Exception {
	 * 
	 * File f = new File(
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
	 ...
	 * }
	 * 
	 * public static void excelWriteAdactinHotel(int row, int cell, String value)
	 * throws Exception {
	 * 
	 * File f = new File(
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
	 ...
	 * }
	 * 
	 * public static void excelWrite2(int row, int cell, String value) throws
	 * Exception {
	 * 
	 * File f = new File(
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
	 ...
	 * }
	 * 
	 * public static void excelWrite1(int row, int cell, String value) throws
	 * Exception {
	 * 
	 * File f = new File(
	 * "C:\\Users\\Ram\\eclipse-workspace\\TestNg_FrameWork\\Excel_Folder\\Pom_Excel.xlsx"
